...
1. <large id="f1"> Cette date a été attribuée à ce message parce qu’il a été publié après le message lié de Jean qui est facilement daté. Cependant, ce message ne mentionne que Jean, et non Samuel et Luc, comme le suggère l’entrée de la tablette à cette date. Donc il se peut que la date attribuée à ce message ne soit pas correcte.[↩](#a1)
