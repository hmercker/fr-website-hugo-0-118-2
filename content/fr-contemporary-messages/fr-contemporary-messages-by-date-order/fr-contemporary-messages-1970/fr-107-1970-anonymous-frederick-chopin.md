...
Bonsoir, je viens parler à travers cet instrument pour la première fois, Je suis Chopin.<sup id="a1">[1](#f1)</sup>
...
1. <large id="f1"> Frédéric Chopin  s'est exprimé dans les messages suivants : [↩](#a1)
